# Observation - FR Observation Transfusion Accidents Document - ANS IG document core v0.1.0-snapshot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation - FR Observation Transfusion Accidents Document**

## Resource Profile: Observation - FR Observation Transfusion Accidents Document 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-observation-transfusion-accidents-document | *Version*:0.1.0-snapshot |
| Draft as of 2026-06-22 | *Computable Name*:FRObservationTransfusionAccidentsDocument |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-observation-transfusion-accidents-document)
...
Other representations of profile: [CSV](StructureDefinition-fr-observation-transfusion-accidents-document.csv), [Excel](StructureDefinition-fr-observation-transfusion-accidents-document.xlsx), [Schematron](StructureDefinition-fr-observation-transfusion-accidents-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-observation-transfusion-accidents-document",
  "version" : "0.1.0-snapshot",
  "name" : "FRObservationTransfusionAccidentsDocument",
