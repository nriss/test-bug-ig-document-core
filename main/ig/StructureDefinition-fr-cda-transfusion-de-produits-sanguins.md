# CDA - FR Transfusion de produits sanguins - ANS IG document core v0.1.0-snapshot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CDA - FR Transfusion de produits sanguins**

## Logical Model: CDA - FR Transfusion de produits sanguins 
...
| Draft as of 2026-06-22 | *Computable Name*:FRCDATransfusionDeProduitsSanguins |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-transfusion-de-produits-sanguins)
...
Other representations of profile: [CSV](StructureDefinition-fr-cda-transfusion-de-produits-sanguins.csv), [Excel](StructureDefinition-fr-cda-transfusion-de-produits-sanguins.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-transfusion-de-produits-sanguins",
  ...
  "differential" : {
    ...
    {
      "id" : "Observation.templateId:frTransfusionDeProduitsSanguins",
      "path" : "Observation.templateId",
      "sliceName" : "frTransfusionDeProduitsSanguins",
      "short" : "Conformité FR-Transfusion-de-produits-sanguins (CI-SIS)",
      "definition" : "Conformité FR-Transfusion-de-produits-sanguins (CI-SIS)",
      "min" : 1,
      "max" : "1"
    },
    {
      "id" : "Observation.templateId:frTransfusionDeProduitsSanguins.root",
      "path" : "Observation.templateId.root",
      "min" : 1,
      "patternString" : "1.2.250.1.213.1.1.3.48.10"
    },
    {
