# Observation - FR Observation Medical Summary Document - ANS IG document core v0.1.0-snapshot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation - FR Observation Medical Summary Document**

## Resource Profile: Observation - FR Observation Medical Summary Document 
...
| Draft as of 2026-06-01 | *Computable Name*:FRObservationMedicalSummaryDocument |
...
Other representations of profile: [CSV](StructureDefinition-fr-observation-medical-summary-document.csv), [Excel](StructureDefinition-fr-observation-medical-summary-document.xlsx), [Schematron](StructureDefinition-fr-observation-medical-summary-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-observation-medical-summary-document",
