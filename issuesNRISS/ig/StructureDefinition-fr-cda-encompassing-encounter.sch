...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile EncompassingEncounter
  ...
  -->
  <sch:pattern>
    <sch:title>f:EncompassingEncounter</sch:title>
    <sch:rule context="f:EncompassingEncounter">
      <sch:assert test="count(f:sdtcAdmissionReferralSourceCode) &lt;= 0">sdtcAdmissionReferralSourceCode: maximum cardinality of 'sdtcAdmissionReferralSourceCode' is 0</sch:assert>
      <sch:assert test="count(f:location) &gt;= 1">location: minimum cardinality of 'location' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:EncompassingEncounter/f:typeId</sch:title>
    <sch:rule context="f:EncompassingEncounter/f:typeId">
  ...
  <sch:pattern>
    <sch:title>f:EncompassingEncounter/f:code</sch:title>
    <sch:rule context="f:EncompassingEncounter/f:code">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:EncompassingEncounter/f:responsibleParty</sch:title>
    <sch:rule context="f:EncompassingEncounter/f:responsibleParty">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:EncompassingEncounter/f:responsibleParty/f:typeId</sch:title>
    <sch:rule context="f:EncompassingEncounter/f:responsibleParty/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
      <sch:assert test="count(f:assigningAuthorityName) &lt;= 0">assigningAuthorityName: maximum cardinality of 'assigningAuthorityName' is 0</sch:assert>
      <sch:assert test="count(f:displayable) &lt;= 0">displayable: maximum cardinality of 'displayable' is 0</sch:assert>
    </sch:rule>
  ...
  <sch:pattern>
    <sch:title>f:EncompassingEncounter/f:location</sch:title>
    <sch:rule context="f:EncompassingEncounter/f:location">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
      <sch:assert test="count(f:typeCode) &lt;= 0">typeCode: maximum cardinality of 'typeCode' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:EncompassingEncounter/f:location/f:typeId</sch:title>
    <sch:rule context="f:EncompassingEncounter/f:location/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
      <sch:assert test="count(f:assigningAuthorityName) &lt;= 0">assigningAuthorityName: maximum cardinality of 'assigningAuthorityName' is 0</sch:assert>
      <sch:assert test="count(f:displayable) &lt;= 0">displayable: maximum cardinality of 'displayable' is 0</sch:assert>
    </sch:rule>
