...
## Logical Model: CDA - FR Accidents transfusionnels 
...
| Draft as of 2026-06-22 | *Computable Name*:FRCDAAccidentsTransfusionnels |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-accidents-transfusionnels)
...
Other representations of profile: [CSV](StructureDefinition-fr-cda-accidents-transfusionnels.csv), [Excel](StructureDefinition-fr-cda-accidents-transfusionnels.xlsx) 
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "Observation.templateId:frAccidentsTransfusionnels",
      "path" : "Observation.templateId",
      "sliceName" : "frAccidentsTransfusionnels",
      "short" : "Conformité FR-Accidents transfusionnels (CI-SIS)",
      "definition" : "Conformité FR-Accidents transfusionnels (CI-SIS)",
      "min" : 1,
      "max" : "1"
    },
    {
      "id" : "Observation.templateId:frAccidentsTransfusionnels.root",
      "path" : "Observation.templateId.root",
      "min" : 1,
      "patternString" : "1.2.250.1.213.1.1.3.48.1"
    },
    {
    ...
    },
    {
      ...
      "short" : "Auteur de l'observation accident transfusionnel",
      "definition" : "Auteur de l'observation accident transfusionnel",
      "max" : "1",
      "type" : [{
