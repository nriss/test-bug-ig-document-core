...
* Use this Logical Model: [Logical model - FR LM SocialHistory](StructureDefinition-fr-lm-social-history.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-lm-observation-social-history)
