...
## Logical Model: CDA - FR Statut du document 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-statut-du-document)
...
Other representations of profile: [CSV](../StructureDefinition-fr-cda-statut-du-document.csv), [Excel](../StructureDefinition-fr-cda-statut-du-document.xlsx) 
