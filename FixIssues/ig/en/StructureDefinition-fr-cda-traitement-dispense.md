...
* Use this Logical Model Profile: [CDA - FR Dispensation medicaments](StructureDefinition-fr-cda-dispensation-medicaments.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-traitement-dispense)
