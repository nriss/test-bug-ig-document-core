# CDA - FR En rapport avec la prevention - ANS IG document core v0.1.0-snapshot
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-en-rapport-avec-la-prevention)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "Conformité FR-En-rapport-avec-la-prevention",
      "min" : 1,
      "max" : "1"
    },
    {
    ...
    },
    {
      ...
      "patternString" : "En rapport avec la prévention",
      "mustSupport" : true
    },
    {
      "id" : "Observation.text",
    ...
    },
    {
      ...
      "short" : "Résultat de l'observation - L'attribut @value pourra prendre l'une des deux valeurs suivantes: value='true' : le traitement est prescrit dans le cadre d'une prévention value='false' : le traitement n'est pas prescrit dans le cadre d'une prévention",
