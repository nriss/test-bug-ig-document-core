...
* Use this Logical Model Profile: [CDA - FR Plan de soins](StructureDefinition-fr-cda-plan-de-soins.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-demande-d-examen-ou-de-suivi)
