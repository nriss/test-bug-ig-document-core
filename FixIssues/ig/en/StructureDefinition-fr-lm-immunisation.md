...
* Use this Logical Model: [Logical model - FR LM Immunisations](StructureDefinition-fr-lm-immunisations.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-lm-immunisation)
