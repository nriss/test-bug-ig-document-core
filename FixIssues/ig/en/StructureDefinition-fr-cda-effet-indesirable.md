...
* Use this Logical Model Profile: [CDA - FR Effets indesirables](StructureDefinition-fr-cda-effets-indesirables.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-effet-indesirable)
