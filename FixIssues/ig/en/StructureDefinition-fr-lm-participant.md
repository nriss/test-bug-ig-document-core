...
* Use this Logical Model: [Logical model - FR LM Encounter](StructureDefinition-fr-lm-encounter.md) and [Logical model - FR LM Header Document](StructureDefinition-fr-lm-header-document.md)
