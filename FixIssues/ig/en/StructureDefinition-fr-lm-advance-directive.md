...
* Use this Logical Model: [Logical model - FR LM Advance Directives](StructureDefinition-fr-lm-advance-directives.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-lm-advance-directive)
