# CDA - FR Synthese medicale sejour - ANS IG document core v0.1.0-snapshot
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-synthese-medicale-sejour)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "Conformité FR-Synthese-medicale-sejour (CI-SIS)",
      "min" : 1,
      "max" : "1"
    },
    {
    ...
    },
    {
      ...
      "definition" : "Synthèse médicale du séjour",
      "min" : 1,
      "max" : "1",
      "type" : [{
