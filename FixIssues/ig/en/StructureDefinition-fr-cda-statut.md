...
* Use this Logical Model Profile: [CDA - FR Evaluation](StructureDefinition-fr-cda-evaluation.md) and [CDA - FR Evenement](StructureDefinition-fr-cda-evenement.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-statut)
