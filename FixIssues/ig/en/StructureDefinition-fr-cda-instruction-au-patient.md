# CDA - FR Instruction au patient - ANS IG document core v0.1.0-snapshot
...
* Use this Logical Model Profile: [CDA - FR Instructions au patient](StructureDefinition-fr-cda-instructions-au-patient.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-instruction-au-patient)
