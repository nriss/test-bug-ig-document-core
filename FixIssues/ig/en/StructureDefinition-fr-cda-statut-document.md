...
## Logical Model: CDA - FR Statut document 
...
* Use this Logical Model Profile: [CDA - FR Statut du document](StructureDefinition-fr-cda-statut-du-document.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-statut-document)
...
Other representations of profile: [CSV](../StructureDefinition-fr-cda-statut-document.csv), [Excel](../StructureDefinition-fr-cda-statut-document.xlsx) 
