...
* Use this Logical Model Profile: [CDA - FR DICOM Object Catalog](StructureDefinition-fr-cda-dicom-object-catalog.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-dicom-examen-imagerie)
