...
* Use this Logical Model Profile: [CDA - FR Vaccin recommande](StructureDefinition-fr-cda-vaccin-recommande.md) and [CDA - FR Vaccination](StructureDefinition-fr-cda-vaccination.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-rang-de-la-vaccination)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "Conformité Medication series number observation (CCD)",
      "min" : 1,
      "max" : "1"
    },
    {
    ...
    },
    {
      ...
      "definition" : "Conformité FR-Rang-de-la-vaccination (CI-SIS)",
      "min" : 1,
      "max" : "1"
    },
    {
