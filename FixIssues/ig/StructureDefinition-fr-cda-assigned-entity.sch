...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile AssignedEntity
  ...
  -->
  <sch:pattern>
    <sch:title>f:AssignedEntity</sch:title>
    <sch:rule context="f:AssignedEntity">
  ...
  <sch:pattern>
    <sch:title>f:AssignedEntity/f:typeId</sch:title>
    <sch:rule context="f:AssignedEntity/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:AssignedEntity/f:id</sch:title>
    <sch:rule context="f:AssignedEntity/f:id">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
      <sch:assert test="count(f:assigningAuthorityName) &lt;= 0">assigningAuthorityName: maximum cardinality of 'assigningAuthorityName' is 0</sch:assert>
      <sch:assert test="count(f:displayable) &lt;= 0">displayable: maximum cardinality of 'displayable' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:AssignedEntity/f:code</sch:title>
    <sch:rule context="f:AssignedEntity/f:code">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
