...
| Draft as of 2026-06-22 | *Computable Name*:FRCDASectionResultats |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-section-resultats)
...
Other representations of profile: [CSV](StructureDefinition-fr-cda-section-resultats.csv), [Excel](StructureDefinition-fr-cda-section-resultats.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-section-resultats",
  ...
  "differential" : {
    ...
    {
      "id" : "Section.templateId:frSectionResultats.root",
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-resultats"]
      }]
    }]
  }
}
