...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile Performer1
  ...
  -->
  <sch:pattern>
    <sch:title>f:Performer1/f:typeId</sch:title>
    <sch:rule context="f:Performer1/f:typeId">
  ...
  <sch:pattern>
    <sch:title>f:Performer1/f:assignedEntity</sch:title>
    <sch:rule context="f:Performer1/f:assignedEntity">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Performer1/f:assignedEntity/f:typeId</sch:title>
    <sch:rule context="f:Performer1/f:assignedEntity/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
      <sch:assert test="count(f:assigningAuthorityName) &lt;= 0">assigningAuthorityName: maximum cardinality of 'assigningAuthorityName' is 0</sch:assert>
      <sch:assert test="count(f:displayable) &lt;= 0">displayable: maximum cardinality of 'displayable' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Performer1/f:assignedEntity/f:id</sch:title>
    <sch:rule context="f:Performer1/f:assignedEntity/f:id">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
      <sch:assert test="count(f:assigningAuthorityName) &lt;= 0">assigningAuthorityName: maximum cardinality of 'assigningAuthorityName' is 0</sch:assert>
      <sch:assert test="count(f:displayable) &lt;= 0">displayable: maximum cardinality of 'displayable' is 0</sch:assert>
      <sch:assert test="count(f:root) &gt;= 1">root: minimum cardinality of 'root' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Performer1/f:assignedEntity/f:code</sch:title>
    <sch:rule context="f:Performer1/f:assignedEntity/f:code">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
      <sch:assert test="count(f:code) &lt;= 1">code: maximum cardinality of 'code' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Performer1/f:assignedEntity/f:sdtcPatient</sch:title>
    <sch:rule context="f:Performer1/f:assignedEntity/f:sdtcPatient">
      <sch:assert test="count(f:id) &gt;= 1">id: minimum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
