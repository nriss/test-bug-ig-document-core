...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile RecordTarget
  ...
  -->
  <sch:pattern>
    <sch:title>f:RecordTarget</sch:title>
    <sch:rule context="f:RecordTarget">
  ...
  <sch:pattern>
    <sch:title>f:RecordTarget/f:typeId</sch:title>
    <sch:rule context="f:RecordTarget/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
