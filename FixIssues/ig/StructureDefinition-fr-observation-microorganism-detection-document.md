...
| Draft as of 2026-06-16 | *Computable Name*:FRObservationMicroorganismDetectionDocument |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-observation-microorganism-detection-document)
...
Other representations of profile: [CSV](StructureDefinition-fr-observation-microorganism-detection-document.csv), [Excel](StructureDefinition-fr-observation-microorganism-detection-document.xlsx), [Schematron](StructureDefinition-fr-observation-microorganism-detection-document.sch) 
    ...
    },
    {
      ...
      "patternCodeableConcept" : {
        "coding" : [{
          ...
          "code" : "MED-309",
          "display" : "Recherche de microorganismes multi-résistants ou émergents effectuée"
        }]
      },
      "mustSupport" : true
    },
