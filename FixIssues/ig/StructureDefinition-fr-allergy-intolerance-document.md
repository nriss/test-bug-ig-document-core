...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-allergy-intolerance-document | *Version*:0.1.0-snapshot |
| Draft as of 2026-06-22 | *Computable Name*:FRAllergyIntoleranceDocument |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-allergy-intolerance-document)
...
Other representations of profile: [CSV](StructureDefinition-fr-allergy-intolerance-document.csv), [Excel](StructureDefinition-fr-allergy-intolerance-document.xlsx), [Schematron](StructureDefinition-fr-allergy-intolerance-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-allergy-intolerance-document",
