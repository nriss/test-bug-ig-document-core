...
## Logical Model: CDA - FR DICOM Acte imagerie 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-dicom-acte-imagerie | *Version*:0.1.0-snapshot |
| Draft as of 2026-06-18 | *Computable Name*:FRCDASectionDICOMActeImagerie |
...
Other representations of profile: [CSV](StructureDefinition-fr-cda-dicom-acte-imagerie.csv), [Excel](StructureDefinition-fr-cda-dicom-acte-imagerie.xlsx) 
