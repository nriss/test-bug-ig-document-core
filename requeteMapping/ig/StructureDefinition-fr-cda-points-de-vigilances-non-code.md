...
## Logical Model: CDA - FR Points de vigilances non code 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-points-de-vigilances-non-code | *Version*:0.1.0-snapshot |
| Draft as of 2026-06-08 | *Computable Name*:FRCDASectionPointsDeVigilancesNonCode |
...
Other representations of profile: [CSV](StructureDefinition-fr-cda-points-de-vigilances-non-code.csv), [Excel](StructureDefinition-fr-cda-points-de-vigilances-non-code.xlsx) 
