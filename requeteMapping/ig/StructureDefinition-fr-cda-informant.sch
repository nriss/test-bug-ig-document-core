...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile Informant
  ...
  -->
  <sch:pattern>
    <sch:title>f:Informant</sch:title>
    <sch:rule context="f:Informant">
  ...
  <sch:pattern>
    <sch:title>f:Informant/f:typeId</sch:title>
    <sch:rule context="f:Informant/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 0">nullFlavor: maximum cardinality of 'nullFlavor' is 0</sch:assert>
