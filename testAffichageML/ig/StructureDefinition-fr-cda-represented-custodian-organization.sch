...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile CustodianOrganization
  ...
  -->
  <sch:pattern>
    <sch:title>f:CustodianOrganization</sch:title>
    <sch:rule context="f:CustodianOrganization">
      ...
      <sch:assert test="count(f:sdtcTelecom) &lt;= 0">sdtcTelecom: maximum cardinality of 'sdtcTelecom' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:CustodianOrganization/f:typeId</sch:title>
    <sch:rule context="f:CustodianOrganization/f:typeId">
  ...
  <sch:pattern>
    <sch:title>f:CustodianOrganization/f:id</sch:title>
    <sch:rule context="f:CustodianOrganization/f:id">
