...
| Draft as of 2026-05-18 | *Computable Name*:FRLMSection |
...
* Utilise ce/t/te Modèle logique: [Logical model - FR LM Section](StructureDefinition-fr-lm-section.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "*",
      "type" : [{
        "code" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-section"
      }]
    },
    {
