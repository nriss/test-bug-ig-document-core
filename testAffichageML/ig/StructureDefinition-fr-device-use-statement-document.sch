...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:DeviceUseStatement/f:source/f:extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DeviceUseStatement/f:source/f:extension/f:extension</sch:title>
    <sch:rule context="f:DeviceUseStatement/f:source/f:extension/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
