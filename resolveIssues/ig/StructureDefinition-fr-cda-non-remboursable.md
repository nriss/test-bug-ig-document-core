# CDA - FR Non remboursable - ANS IG document core v0.1.0-snapshot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CDA - FR Non remboursable**

## Logical Model: CDA - FR Non remboursable 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-non-remboursable | *Version*:0.1.0-snapshot |
| Draft as of 2026-06-04 | *Computable Name*:FRCDANonRemboursable |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-non-remboursable)
...
Other representations of profile: [CSV](StructureDefinition-fr-cda-non-remboursable.csv), [Excel](StructureDefinition-fr-cda-non-remboursable.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-non-remboursable",
  ...
  "differential" : {
    ...
    {
      "id" : "Observation.templateId:frNonRemboursable",
      "path" : "Observation.templateId",
      "sliceName" : "frNonRemboursable",
      "short" : "Conformité FR-Non-remboursable (CI-SIS)",
      "definition" : "Conformité FR-Non-remboursable (CI-SIS)",
      "min" : 1,
      "max" : "1"
    },
    {
      "id" : "Observation.templateId:frNonRemboursable.root",
      "path" : "Observation.templateId.root",
      "min" : 1,
      "patternString" : "1.2.250.1.213.1.1.3.48.15"
    },
    {
    ...
    },
    {
      ...
      "patternString" : "Non remboursable",
      "mustSupport" : true
    },
    {
      "id" : "Observation.text",
    ...
    },
    {
      ...
      "short" : "Status de l'observation. Fixé à la valeur 'completed'",
