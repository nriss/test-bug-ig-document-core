# CDA - FR Identification micro organismes multiresistants - ANS IG document core v0.1.0-snapshot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CDA - FR Identification micro organismes multiresistants**

## Logical Model: CDA - FR Identification micro organismes multiresistants 
...
| Draft as of 2026-06-09 | *Computable Name*:FRCDAIdentificationMicroOrganismesMultiresistants |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-identification-micro-organismes-multiresistants)
...
Other representations of profile: [CSV](StructureDefinition-fr-cda-identification-micro-organismes-multiresistants.csv), [Excel](StructureDefinition-fr-cda-identification-micro-organismes-multiresistants.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-identification-micro-organismes-multiresistants",
  ...
  "differential" : {
    ...
    {
      "id" : "Observation.templateId:frIdentificationMicroOrganismesMultiresistants",
      "path" : "Observation.templateId",
      "sliceName" : "frIdentificationMicroOrganismesMultiresistants",
      "short" : "Conformité FR-Identification-micro-organismes-multiresistants (CI-SIS)",
      "definition" : "Conformité FR-Identification-micro-organismes-multiresistants (CI-SIS)",
      "min" : 1,
      "max" : "1"
    },
    {
      "id" : "Observation.templateId:frIdentificationMicroOrganismesMultiresistants.root",
      "path" : "Observation.templateId.root",
      "min" : 1,
      "patternString" : "1.2.250.1.213.1.1.3.48.5"
    },
    {
