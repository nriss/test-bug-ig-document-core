...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile InFulfillmentOf
  ...
  -->
  <sch:pattern>
    <sch:title>f:InFulfillmentOf/f:typeId</sch:title>
    <sch:rule context="f:InFulfillmentOf/f:typeId">
