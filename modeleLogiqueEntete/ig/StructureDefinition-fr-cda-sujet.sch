...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile Subject
  ...
  -->
  <sch:pattern>
    <sch:title>f:Subject/f:templateId</sch:title>
    <sch:rule context="f:Subject/f:templateId">
  ...
  <sch:pattern>
    <sch:title>f:Subject/f:relatedSubject</sch:title>
    <sch:rule context="f:Subject/f:relatedSubject">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Subject/f:relatedSubject/f:typeId</sch:title>
    <sch:rule context="f:Subject/f:relatedSubject/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:assigningAuthorityName) &lt;= 1">assigningAuthorityName: maximum cardinality of 'assigningAuthorityName' is 1</sch:assert>
      <sch:assert test="count(f:displayable) &lt;= 1">displayable: maximum cardinality of 'displayable' is 1</sch:assert>
      <sch:assert test="count(f:root) &gt;= 1">root: minimum cardinality of 'root' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Subject/f:relatedSubject/f:code</sch:title>
    <sch:rule context="f:Subject/f:relatedSubject/f:code">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:code) &gt;= 1">code: minimum cardinality of 'code' is 1</sch:assert>
      <sch:assert test="count(f:code) &lt;= 1">code: maximum cardinality of 'code' is 1</sch:assert>
