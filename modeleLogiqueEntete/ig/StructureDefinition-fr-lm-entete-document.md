...
| Draft as of 2026-06-09 | *Computable Name*:FRLMEnteteDocument |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-entete-document.intendedRecipient",
      "path" : "fr-lm-entete-document.intendedRecipient",
    ...
    {
      "id" : "fr-lm-entete-document.consent",
      "path" : "fr-lm-entete-document.consent",
