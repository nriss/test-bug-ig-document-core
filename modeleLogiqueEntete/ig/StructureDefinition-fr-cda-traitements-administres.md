# CDA - FR Traitements administres - ANS IG document core v0.1.0-snapshot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CDA - FR Traitements administres**

## Logical Model: CDA - FR Traitements administres 
...
| Draft as of 2026-06-09 | *Computable Name*:FRCDASectionTraitementsAdministres |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-cda-traitements-administres)
...
Other representations of profile: [CSV](StructureDefinition-fr-cda-traitements-administres.csv), [Excel](StructureDefinition-fr-cda-traitements-administres.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-traitements-administres",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "Conformité Medications-Administered (IHE-PCC)",
      "min" : 1,
      "max" : "1"
    },
    {
      ...
      "min" : 1,
      "patternString" : "1.3.6.1.4.1.19376.1.5.3.1.3.21"
    },
    {
      "id" : "Section.templateId:frSectionTraitementsAdministres",
      "path" : "Section.templateId",
      "sliceName" : "frSectionTraitementsAdministres",
      "short" : "Conformité FR-Traitements-administres (CISIS)",
      "min" : 1,
      "max" : "1"
    },
    {
      "id" : "Section.templateId:frSectionTraitementsAdministres.root",
      "path" : "Section.templateId.root",
      "min" : 1,
