# Observation - FR Observation Multiresistant Microorganisms Identification Document - ANS IG document core v0.1.0-snapshot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation - FR Observation Multiresistant Microorganisms Identification Document**

## Resource Profile: Observation - FR Observation Multiresistant Microorganisms Identification Document 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-observation-multiresistant-microorganism-document | *Version*:0.1.0-snapshot |
| Draft as of 2026-06-09 | *Computable Name*:FRObservationMultiresistantMicroorganismsIdentificationDocument |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-observation-multiresistant-microorganism-document)
...
Other representations of profile: [CSV](StructureDefinition-fr-observation-multiresistant-microorganism-document.csv), [Excel](StructureDefinition-fr-observation-multiresistant-microorganism-document.xlsx), [Schematron](StructureDefinition-fr-observation-multiresistant-microorganism-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-observation-multiresistant-microorganism-document",
  "version" : "0.1.0-snapshot",
  "name" : "FRObservationMultiresistantMicroorganismsIdentificationDocument",
    ...
    },
    {
      ...
      "patternCodeableConcept" : {
        "coding" : [{
          ...
          "code" : "MED-144",
          "display" : "Identification de micro-organismes multirésistants"
        }]
      },
      "mustSupport" : true
    },
