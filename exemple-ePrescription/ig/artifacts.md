...
* `status` : le statut est inconnu → code d’exception `unknown` du ValueSet `event-status` (liaison required → on utilise directement le code d’exception du ValueSet, pas l’extension)
 |
| [ExampleBundlePrescription](Bundle-example-bundle-Prescription.md) | Exemple Bundle : Prescriptions de médicaments-paracétamol-préparation-magistrale, avec des sections pour les signes vitaux, l’historique des grossesses et la copie du document, ainsi qu’un code 2D de la prescription. |
| [ExampleBundlePrescription-PosoNonStruct](Bundle-example-bundle-Prescription-PosoNonStruct.md) | Bundle example: non-structured dosing (narrative dosageInstruction) |
...
| [Prescription de médicaments et/ou de dispositifs médicaux](Composition-compositionPrescription.md) | Composition d’exemple pour une Prescription, pour l’entête et le corps du document |
| [Prescription de médicaments et/ou de dispositifs médicaux](Composition-compositionPrescription-NS.md) | Composition d’exemple pour une Prescription non structurée |
...
| [medicationRequest-NS-01](MedicationRequest-medreq-NS-01.md) |  |
| [medicationRequest-NS-02](MedicationRequest-medreq-NS-02.md) |  |
| [organizationPrescription-03](Organization-organizationPrescription-03.md) |  |
| [organizationPrescription-03-NS](Organization-organizationPrescription-03-NS.md) |  |
| [practitionerRoleRemplacant](PractitionerRole-practitionerRoleRemplacant.md) |  |
| [practitionerRoleRemplacant-NS](PractitionerRole-practitionerRoleRemplacant-NS.md) |  |
