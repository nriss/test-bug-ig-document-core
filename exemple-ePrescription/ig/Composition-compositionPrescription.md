...
* type: REF
* time: ?? --> (en cours)
* party: [PractitionerRole null](PractitionerRole-practitionerRoleRemplacant.md)

> **Participant Extension**
* type: PRF
* time: ?? --> 2023-12-02 09:30:00+0100
* party: [PractitionerRole Pharmacist](Bundle-example-bundle-Prescription.md#PractitionerRole_practitionerRolePharmacien)
...
**author**: [PractitionerRole ](Bundle-example-bundle-Prescription.md#PractitionerRole_practitionerRolePrescription-02)

**title**: Prescription de médicaments et/ou de dispositifs médicaux

**confidentiality**: normal

> **attester****mode**: Legal**time**: 2026-04-28 09:30:00+0200**party**: [PractitionerRole ](Bundle-example-bundle-Prescription.md#PractitionerRole_practitionerRolePrescription-01)
