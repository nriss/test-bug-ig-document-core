...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Supply">
      <sch:assert test="count(f:independentInd) &gt;= 1">independentInd: minimum cardinality of 'independentInd' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Supply/f:independentInd</sch:title>
    <sch:rule context="f:Supply/f:independentInd">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Supply/f:quantity</sch:title>
    <sch:rule context="f:Supply/f:quantity">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
