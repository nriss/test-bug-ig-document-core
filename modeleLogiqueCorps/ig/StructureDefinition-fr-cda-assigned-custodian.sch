...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile AssignedCustodian
  ...
  -->
  <sch:pattern>
    <sch:title>f:AssignedCustodian/f:typeId</sch:title>
    <sch:rule context="f:AssignedCustodian/f:typeId">
